...
{
pcre2_code *re;
PCRE2_SPTR pattern = (PCRE2_SPTR) R"((\d+)|[+\-*/^()ie=]|pi|tau|\S)";     /* PCRE2_SPTR is a pointer to unsigned code units of */
PCRE2_SPTR subject = (PCRE2_SPTR) "ab + 2 / piΣ";     /* the appropriate width (8, 16, or 32 bits). */
